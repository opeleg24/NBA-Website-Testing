    ...
    def test_golden_state_warriors_roster_players_stats(self):
        ...
        for player in self.Warriors_Page().getRosterPlayersForPlayerStats():
            ...
            if self.Warriors_Page().getIsPlayer().text != '':  # there IS a player stats
                ...
                self.Warriors_Page().pressPlayersStatsNumGamesStartedHeader().click()
                # time.sleep(0.5)
                games_started_reverse_int = [int(i) for i in self.Warriors_Page().getPlayersStatsNumGamesStartedReverse()]
                ...
                # time.sleep(0.5)
                free_throw_percentage_float = [float(i) for i in self.Warriors_Page().getPlayersStatsFreethrowPercentage()]
                ...
                self.Warriors_Page().pressPlayersStatsDoubleDoublesHeader().click()
                # time.sleep(0.5)
                double_doubles_reverse_int = [int(i) for i in self.Warriors_Page().getPlayersStatsDoubleDoublesReverse()]
                ...
                self.Warriors_Page().pressPlayersStatsTripleDoublesHeader().click()
                # time.sleep(0.5)
                triple_doubles_reverse_int = [int(i) for i in self.Warriors_Page().getPlayersStatsTripleDoublesReverse()]
