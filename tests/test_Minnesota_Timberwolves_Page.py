...
class TestMinnesotaTimberwolvesPage(BaseClass):
    ...
    def test_minnesota_timberwolves_roster_players_stats(self):
        ...
        for player in self.Timberwolves_Page().getRosterPlayersForPlayerStats():
            ...
            if self.Timberwolves_Page().getIsPlayer().text != '':  # there IS a player stats
                ...
                self.Timberwolves_Page().pressPlayersStatsNumGamesStartedHeader().click()
                # time.sleep(0.5)
                games_started_reverse_int = [int(i) for i in self.Timberwolves_Page().getPlayersStatsNumGamesStartedReverse()]
                ...
                # time.sleep(0.5)
                free_throw_percentage_float = [float(i) for i in self.Timberwolves_Page().getPlayersStatsFreethrowPercentage()]
                ...
                self.Timberwolves_Page().pressPlayersStatsDoubleDoublesHeader().click()
                # time.sleep(0.5)
                double_doubles_reverse_int = [int(i) for i in self.Timberwolves_Page().getPlayersStatsDoubleDoublesReverse()]
                ...
                self.Timberwolves_Page().pressPlayersStatsTripleDoublesHeader().click()
                # time.sleep(0.5)
                triple_doubles_reverse_int = [int(i) for i in self.Timberwolves_Page().getPlayersStatsTripleDoublesReverse()]
    ...
    def test_minnesota_timberwolves_salaries_sorted_eight_teen_nine_teen_column(self):
        ...
        eight_teen_nine_teen_players_sorted = sorted(self.Timberwolves_Page().getEightTeenNineTeenPlayers(), reverse=True)
    ...
    def test_minnesota_timberwolves_salaries_sorted_eight_teen_nine_teen_reverse_column(self):
        ...
        self.Timberwolves_Page().pressSalariesEightTeenNineTeenHeader().click()
        eight_teen_nine_teen_players_sorted_reverse = sorted(self.Timberwolves_Page().getEightTeenNineTeenPlayersReverse())
