    ...
    def test_memphis_grizzlies_roster_players_stats(self):
        ...
        for player in self.Grizzlies_Page().getRosterPlayersForPlayerStats():
            ...
            if self.Grizzlies_Page().getIsPlayer().text != '':  # there IS a player stats
                ...
                self.Grizzlies_Page().pressPlayersStatsNumGamesStartedHeader().click()
                # time.sleep(0.5)
                games_started_reverse_int = [int(i) for i in self.Grizzlies_Page().getPlayersStatsNumGamesStartedReverse()]
                ...
                # time.sleep(0.5)
                free_throw_percentage_float = [float(i) for i in self.Grizzlies_Page().getPlayersStatsFreethrowPercentage()]
                ...
                self.Grizzlies_Page().pressPlayersStatsDoubleDoublesHeader().click()
                # time.sleep(0.5)
                double_doubles_reverse_int = [int(i) for i in self.Grizzlies_Page().getPlayersStatsDoubleDoublesReverse()]
                ...
                self.Grizzlies_Page().pressPlayersStatsTripleDoublesHeader().click()
                # time.sleep(0.5)
                triple_doubles_reverse_int = [int(i) for i in self.Grizzlies_Page().getPlayersStatsTripleDoublesReverse()]
