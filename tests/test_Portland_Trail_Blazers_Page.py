...
class TestPortlandTrailBlazersPage(BaseClass):
    ...
    def test_portland_trailblazers_salaries_sorted_eight_teen_nine_teen_column(self):
        ...
        eight_teen_nine_teen_players_sorted = sorted(self.Trailblazers_Page().getEightTeenNineTeenPlayers(),
                                                     reverse=True)
    ...
    def test_portland_trailblazers_salaries_sorted_eight_teen_nine_teen_reverse_column(self):
        ...
        eight_teen_nine_teen_players_sorted_reverse = sorted(
            self.Trailblazers_Page().getEightTeenNineTeenPlayersReverse())
        ...
        for player in self.Trailblazers_Page().getRosterPlayersForPlayerStats():
            ...
            if self.Trailblazers_Page().getIsPlayer().text != '':  # there IS a player stats
                ...
                games_started_reverse_int = [int(i) for i in
                                             self.Trailblazers_Page().getPlayersStatsNumGamesStartedReverse()]
                ...
                free_throw_percentage_float = [float(i) for i in
                                               self.Trailblazers_Page().getPlayersStatsFreethrowPercentage()]
                ...
                double_doubles_reverse_int = [int(i) for i in
                                              self.Trailblazers_Page().getPlayersStatsDoubleDoublesReverse()]
                ...
                triple_doubles_reverse_int = [int(i) for i in
                                              self.Trailblazers_Page().getPlayersStatsTripleDoublesReverse()]
